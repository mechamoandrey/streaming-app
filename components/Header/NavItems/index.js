...
const NavItems = () => {
  return (
    <>
      <Link href="/movie-list/all" aria-label="Home" className="nav-item">
      ...
      <Link href="/movie-list/movie" aria-label="Movies" className="nav-item">
        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg">
      ...
      <Link href="/favorites" aria-label="Favorites" className="nav-item">
